...
public class GraphvizRenderer {
    ...
    private static final String DOT_FILE_PATH = System.getProperty("java.io.tmpdir") + "/(fileName).dot";
    // Path to the output PNG file (system temp directory)
    private static final String PNG_FILE_PATH = System.getProperty("java.io.tmpdir") + "/(fileName).png";
     ...
     * @throws IOException If there is an error reading the DOT file or writing the
     *                     PNG file.
     */
